...
export default function AnalyticsExportMenu() {
  ...
  return (
    <UncontrolledDropdown>
      <DropdownToggle caret color="light" className="da-select-toggle d-inline-flex align-items-center justify-content-between gap-2">
      ...
      <DropdownMenu end className="da-dropdown-menu shadow border-0 rounded-3">
